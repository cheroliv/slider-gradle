...
image::readme_images/en/diag-plantuml-md5-d758a044781a4f2f0f1123104209fd2a.png[]

=== Global Flow Overview

image::readme_images/en/diag-plantuml-md5-7f8f99cb312b79fc3bc8a668a4fa8c3c.png[]
...
image::readme_images/en/diag-plantuml-md5-ff2966af3b562bc41d9773264e14f34e.png[]

=== Gradle Execution Cycle

image::readme_images/en/diag-plantuml-md5-add7fef62067ea9f7c0a7c8e8fa8ef40.png[]
...
image::readme_images/en/diag-plantuml-md5-56bf09458477a5db6d9cc70dd73c7155.png[]
...
`publishSlides`::
Deploys compiled slides to the branch configured in `slides-context.yml` via force push.
With `branch: "slides"`, slides are published to the `slides` branch of the repository — compatible with GitHub Pages.
...
NOTE: Enable GitHub Pages on the `slides` branch in *Settings → Pages* of your repository.
The published URL will be: `https://<organisation>.github.io/<repo>/`

==== Deployment Pipeline

image::readme_images/en/diag-plantuml-md5-e6cd66fe2240b2e9c7bab6647ecaf61f.png[]
...
image::readme_images/en/diag-plantuml-md5-23e54cd995b8aac5f517ec73b757cb7e.png[]

=== Two-Step Generation Pipeline

image::readme_images/en/diag-plantuml-md5-30ecdaace7e57525e521c4eaa0733a8c.png[]
...
image::readme_images/en/diag-plantuml-md5-a352ebd178daa56ae92349e6b674a92d.png[]
...
image::readme_images/en/diag-plantuml-md5-affcc597da302ee7b4e238538f1cf112.png[]
