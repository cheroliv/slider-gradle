...
On the first Gradle task execution, `SliderManager.Scaffold` runs two independent checks
...
Both functions are no-ops if the resource already exists — existing consumer content is never overwritten.
